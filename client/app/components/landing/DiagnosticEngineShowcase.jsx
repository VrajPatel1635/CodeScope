...
export default function DiagnosticEngineShowcase() {
  ...
  return (
    <section className="relative py-24 md:py-32 bg-background overflow-hidden border-t border-white/2">
      ...
      <div className="absolute top-1/2 left-[-10%] w-[600px] h-[600px] bg-emerald-500/5 blur-[120px] rounded-full pointer-events-none mix-blend-screen" />
      <div className="absolute bottom-0 right-[10%] w-[800px] h-[800px] bg-emerald-500/5 blur-[120px] rounded-full pointer-events-none mix-blend-screen" />
          ...
          <div className="lg:col-span-7 order-2 relative lg:ml-4">
            <div className="relative w-full flex flex-col md:flex-row items-stretch gap-4 md:gap-6">
              ...
              >
                ...
                <div className="font-mono text-[10px] sm:text-[11px] leading-[1.8] text-white/30">
                  <span className="text-red-400/60 font-medium">Exception in thread "main"</span><br />
                  <span className="text-red-400/60 font-medium">java.lang.ArrayIndexOutOfBoundsException: Index 5 out of bounds for length 5</span><br />
                  ...
                  <span className="pl-3 block opacity-50">at Solution.solve(Solution.java:12)</span>
                  <span className="pl-3 opacity-30 block">at Main.main(Main.java:8)</span>
                </div>
              </motion.div>
